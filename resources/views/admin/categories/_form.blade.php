<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    <div class="lg:col-span-2 space-y-8">
        <div class="glass-card rounded-3xl p-8 animate-fade-up">
            ...
            <div class="space-y-6">
                <div>
                    <label class="block text-xs font-bold text-lime-100/30 uppercase tracking-widest mb-2">Nama Kategori *</label>
                ...
                <div>
                    <label class="block text-xs font-bold text-lime-100/30 uppercase tracking-widest mb-2">Deskripsi Singkat</label>
        ...
        <div class="glass-card rounded-3xl p-8 animate-fade-up" style="animation-delay: 0.1s">
            ...
            <div class="space-y-8">
                <div>
                    <label class="block text-xs font-bold text-lime-100/30 uppercase tracking-widest mb-2">Ikon (Emoji / SVG)</label>
                ...
                <div>
                    <label class="block text-xs font-bold text-lime-100/30 uppercase tracking-widest mb-4">Gambar Sampul (Banner)</label>
                    <div class="flex items-center gap-6">
                        ...
                        @endif
                        <div class="flex-1">
                            <input type="file" name="image" accept="image/*" class="admin-input w-full px-6 py-3 rounded-2xl file:mr-4 file:py-1 file:px-3 file:rounded-xl file:border-0 file:bg-lime-500/10 file:text-lime-400 file:font-bold file:text-xs">
                        </div>
                    </div>
    ...
    <div class="space-y-8">
        <div class="glass-card rounded-3xl p-8 animate-fade-up" style="animation-delay: 0.2s">
            ...
            <div class="space-y-6">
                <div>
                    <label class="block text-xs font-bold text-lime-100/30 uppercase tracking-widest mb-2">Urutan Tampil</label>
                ...
                <label class="flex items-center group cursor-pointer">
                    ...
                    <span class="ml-4 text-sm font-bold text-lime-100/40 group-hover:text-lime-400 transition-colors">Aktif di Website</span>
                </label>
            </div>
        </div>
