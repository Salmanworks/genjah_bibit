...
<!-- SEJARAH TOKO -->
<section class="relative z-10" style="background: linear-gradient(180deg, #f9f7f4 0%, #f2ede6 50%, #ebe5da 100%); padding: 96px 0; overflow: hidden;">
    <div class="absolute inset-0 pointer-events-none opacity-30 z-0" style="background-image: radial-gradient(circle at 2px 2px, rgba(61,92,56,0.06) 1.5px, transparent 0); background-size: 32px 32px;"></div>
    <div class="absolute right-0 top-24 hidden xl:block pointer-events-none select-none z-0" style="font-size: clamp(8rem, 16vw, 14rem); font-weight: 900; line-height: 1; color: rgba(61,92,56,0.025); letter-spacing: -0.05em;">SEJARAH</div>
        ...
        <div class="grid lg:grid-cols-12 gap-16 lg:gap-16 xl:gap-24 items-start">
            ...
            <div class="lg:col-span-5 lg:sticky lg:top-28">
                <div class="inline-flex items-center gap-3 mb-6 px-4 py-2 rounded-full" style="background: linear-gradient(135deg, rgba(197, 232, 122, 0.15), rgba(61, 92, 56, 0.08)); border: 1px solid rgba(61, 92, 56, 0.15);">
                    <span style="display: inline-block; width: 8px; height: 8px; background: #3d5c38; border-radius: 50%;"></span>
                ...
                <div class="grid grid-cols-3 gap-4 max-w-lg mb-8">
                    <div class="text-center rounded-2xl px-4 py-6" style="background: linear-gradient(135deg, #3d5c38 0%, #2d4428 100%); border: 1px solid rgba(255, 255, 255, 0.1); box-shadow: 0 12px 32px -16px rgba(61, 92, 56, 0.4); transition: all 0.3s ease;">
                    ...
                    <div class="text-center rounded-2xl px-4 py-6" style="background: #ffffff; border: 2px solid rgba(61, 92, 56, 0.12); box-shadow: 0 12px 32px -16px rgba(26, 36, 25, 0.15); transition: all 0.3s ease;">
                ...
                <blockquote class="hidden sm:block pl-6 border-l-4" style="border-color: #c5e87a; background: linear-gradient(135deg, rgba(197, 232, 122, 0.08), rgba(61, 92, 56, 0.03)); padding: 20px 24px; border-radius: 8px; box-shadow: 0 4px 16px -8px rgba(61, 92, 56, 0.1);">
            ...
            <div class="lg:col-span-7 relative">
                <div class="absolute left-[28px] top-8 bottom-8 w-[3px] rounded-full hidden sm:block" style="background: linear-gradient(180deg, #5a7058 0%, rgba(90, 112, 88, 0.6) 50%, rgba(90, 112, 88, 0.2) 100%);"></div>
                ...
                <div class="flex flex-col gap-0 sm:pl-4 relative z-20">
                    @foreach($milestones as $i => $m)
                    <div class="relative sm:pl-20 pb-16 last:pb-0">
                        <div class="hidden sm:flex absolute left-0 top-[24px] z-30 h-14 w-14 items-center justify-center rounded-full border-[3px] shadow-xl" style="background: linear-gradient(145deg, #ffffff, #f9f7f4); border-color: {{ $m['color'] }};">
                            <svg class="h-6 w-6 shrink-0" style="color: {{ $m['color'] }};" fill="none" stroke="currentColor" viewBox="0 0 24 24">{!! $m['icon'] !!}</svg>
                        </div>

                        <div class="relative overflow-hidden rounded-2xl border-2 bg-white p-7 sm:p-8" style="border-color: rgba(26, 36, 25, 0.1); box-shadow: 0 20px 60px -28px rgba(26, 36, 25, 0.2); transition: all 0.4s ease;">
                            ...
                            <div class="relative flex flex-wrap items-center justify-between gap-4 gap-y-3 mb-5">
                                <span class="inline-flex items-center rounded-full px-5 py-2 text-xs font-extrabold tracking-widest shadow-md" style="background: linear-gradient(135deg, #1a2419, #2d4428); color: {{ $m['color'] }};">{{ $m['year'] }}</span>
